...
bitmap_preview_window_x = floor(panel_x + panel_width - bitmap_preview_window_width + 60);
bitmap_preview_window_y = floor(panel_y + panel_height - bitmap_preview_window_height - 58);
