...
function scr_bitmap_editor_layout(_editor) {
    ...
    return {
        ...
        gradient_tool_y : _editor.panel_y + 270,
        gradient_tool_width : 262,
        gradient_colour_label_y : _editor.panel_y + 302,
        gradient_colour_y : _editor.panel_y + 320,
        gradient_colour_width : 127,
        gradient_edge_x : _editor.panel_x + 10,
        gradient_edge_y : _editor.panel_y + 352,
        gradient_edge_width : 262,
        history_y : _editor.panel_y + 394,
        file_y : _editor.panel_y + 426,
        output_y : _editor.panel_y + 458,
